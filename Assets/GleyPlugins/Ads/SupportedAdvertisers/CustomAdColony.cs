namespace GleyMobileAds
{
    ...
    public class CustomAdColony : MonoBehaviour, ICustomAds
    {
        ...
        private bool debug;
        public int minSecondsBetweenInterstitial = 120;
        ...
        public void InitializeAds(GDPRConsent consent, List<PlatformSettings> platformSettings)
        {
            ...
            string[] zoneIDs = new string[] { interstitialZoneId};
...
public int LastInterstitialShowTime {
        ...
        {
            if ((CurrentTime () - LastInterstitialShowTime) > minSecondsBetweenInterstitial){ 
            if (interstitialAd != null)
            {
