namespace GleyMobileAds
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        {
            SettingsWindow window = (SettingsWindow)GetWindow(typeof(SettingsWindow), true, "Mobile Ads Settings Window - v.1.4.7");
        ...
        /// </summary>
        private void CreateManifestFile(string appId)
        {
            ...
            try
            {
                string googleManifest = File.ReadAllText(Application.dataPath + "/Plugins/Android/GoogleMobileAdsPlugin/AndroidManifest.xml");

                string textToReplace = googleManifest.Substring(googleManifest.IndexOf("<meta-data"));

                textToReplace = textToReplace.Substring(0, textToReplace.IndexOf("/>") + 2);
                googleManifest = googleManifest.Replace(textToReplace, "");
                File.WriteAllText(Application.dataPath + "/Plugins/Android/GoogleMobileAdsPlugin/AndroidManifest.xml", googleManifest);
            }
            catch { }
            AssetDatabase.Refresh();
