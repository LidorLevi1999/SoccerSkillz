...
namespace com.F4A.MobileThird
{
    public partial class AdsManager
    {
        ...
        {
#if DEFINE_ADMOB
            return IsEnableAdmobAd() && interstitialAdmob != null && interstitialAdmob.IsLoaded();
#endif
            return false;
        }
        ...
        protected bool IsRewardAdMobReady()
        {
            ...
            try
            {
                var isReady = IsEnableAdmobAd() && rewardedAd != null && rewardedAd.IsLoaded();
                return isReady;
            }
            catch (Exception ex)
            {
