...
#region Variables
        ...
        private float _timeScalePrev = 1;
#endregion
...
#region Interstitial Ads
        ...
        private Action _onInterstitialCompleted = null, _onInterstitialSkiped, _onInterstitialFailed;
        public bool ShowInterstitialAds(int adsInterval = -1, Action onCompleted = null, Action onSkiped = null, 
            Action onFailed = null, string locationId = "")
        {
            _onInterstitialCompleted = onCompleted;
            _onInterstitialSkiped = onSkiped;
...
#region Banner
        ...
        private void LogEventAds(string nameEvent, string nameParamater, string valueParamater)
        {
            ...
            AnalyticManager.Instance.CustomeEvent(nameEvent, paramaters);
        //    FirebaseManager.Instance.LogEvent(nameEvent, paramaters);
        }
